...
class JsonRPCApiClient {
	...
	* @return {Promise} - resolves with the response of json stringified object where the last object is success: true
	* @since v0.0.1
	*/
			...
			return this.authenticate()
				...
				.then((headers) => {
					return new Promise((resolve, reject) => {
						request({ uri, headers, json, method: 'post' }, (error, response, body) => {
